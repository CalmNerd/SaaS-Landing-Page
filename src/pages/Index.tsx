              ...
              <div className="relative z-10 p-12 md:p-16 text-white">
                ...
                >
                  <div className="inline-flex items-center px-4 py-2 rounded-full bg-convrt-purple/20 text-convrt-purple mb-6">
                    ...
                    <span className="text-sm font-medium font-inter tracking-wide">Start Your AI Revolution Today</span>
                  </div>

                  <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">
                    Ready to Move from
                    <span className="text-[#EA384C] font-extrabold"> Manual </span>
                    to
                    <span className="text-convrt-purple font-extrabold"> Automation</span>?
                  </h2>

                  <p className="text-lg text-gray-100 mb-8">
                    Join hundreds of operations teams who have transformed their workflows with AI-driven autonomous agents.
                  </p>

                  <div className="flex flex-col space-y-3 mb-8">
                    {[
                      "18x faster execution than manual processes",
                      "Zero-error autonomous operations",
                      "AI-driven intelligence at unlimited scale"
                    ].map((benefit, i) => (
      ...
      <footer className="bg-white py-8 border-t border-gray-100">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <h3 className="text-2xl font-bold text-convrt-dark-blue">ChillBot</h3>
              <p className="text-sm text-gray-600 mt-2">© {new Date().getFullYear()} ChillBot. All rights reserved.</p>
            </motion.div>
